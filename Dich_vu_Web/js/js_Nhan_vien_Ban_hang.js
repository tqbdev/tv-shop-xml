...
function Func_Sale_Items() {
  var Ho_ten = document.getElementById("Html_Name_Sale_Personel").value;
  if (Ho_ten == "") {
    alert("Bạn chưa nhập họ tên");
    return;
  }

  var Ngay = document.getElementById("Html_Date_Sale").value;
  if (Ngay == "") {
  ...
  var Tham_so = `Ma_so_Xu_ly=Ban_hang`;
  var Tham_so_XML = `<Tham_so Ho_ten="${Ho_ten}" Ngay="${Ngay}" Ma_so="${Ma_so}" So_luong="${So_luong}" Don_gia="${Don_gia}" Tien="${Tien}"></Tham_so>`;
...
function Func_Search_Revenue() {
  var Ho_ten = document.getElementById("Html_Name_Sale_Personel_Search").value;
  if (Ho_ten == "") {
    alert("Bạn chưa nhập họ tên");
    return;
  }

  var Tham_so = `Ma_so_Xu_ly=Doanh_thu_Ca_nhan`;
  var Tham_so_XML = `<Tham_so Ho_ten="${Ho_ten}"></Tham_so>`;
...
function GET_XML_ITEMS_INFO() {
  var Tham_so = "Ma_so_Xu_ly=Doc_Du_lieu&id=Nhan_vien_Ban_hang";
  var Dia_chi_Xu_ly = `${Dia_chi_Dich_vu}?${Tham_so}`;
