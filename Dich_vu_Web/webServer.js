...
app.createServer((req, res) => {
    ...
    req_url = (req.url == '/Khach_Tham_Quan') ? '/MH_Khach_Tham_Quan.html' : req_url
    req_url = (req.url == '/Nhan_vien_Ban_hang') ? '/MH_Nhan_vien_Ban_hang.html' : req_url
    req_url = (req.url == '/Nhan_vien_Nhap_hang') ? '/MH_Nhan_vien_Nhap_hang.html' : req_url
    req_url = (req.url == '/Quan_ly_Ban_hang') ? '/MH_Quan_ly_Ban_hang.html' : req_url
    req_url = (req.url == '/Quan_ly_Nhap_hang') ? '/MH_Quan_ly_Nhap_hang.html' : req_url
